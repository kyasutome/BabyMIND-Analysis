...
for (vector<string>::iterator itFileName=vFileNames.begin(); itFileName != vFileNames.end(); itFileName++) {
 ...
 // return 0;
  ...
  ifs.close();
    ...
    Double_t rangeGain = averageGain/2.; 
    
    Double_t peakWidth = 5;  
    Double_t rangePeaksMin = 10;
  ...
  Peak peak0;
    ...
    if (FEB == 21 || FEB == 29) {
	  ...
	  if (peak.Height>peakHeight && peak.Mean>rangePeaksMin && peak.Mean<rangePeaksMax && peak.Height>peak0.Height) {
