...
int main ()
{
  ...
  for (int ih = 0; ih<FEBnumbers.size();ih++) {
        ...
        /*for (int nent = 0; nent<nentries[FEBnumbers.at(ih)]; nent++)
            FEBtree[FEBnumbers.at(ih)]->GetEntry(nent);*/
        //std::cout << "Number of events = " <<FEB[FEBnumbers.at(ih)].FEBSN->size()<<std::endl;
        sFEBnum.str("");
        ...
        for (int ik = 0; ik < nentries[FEBnumbers.at(ih)] - 1; ik++){
            ...
            //cout << FEBnumbers.at(ih) <<" "<<ik<< " "<<FEB[FEBnumbers.at(ih)].FEBSN->size()<<endl;
            ...
            //cout << FEBnumbers.at(ih) <<" "<<ik+1<< " "<<FEB[FEBnumbers.at(ih)].FEBSN->size()<<endl;
        }
